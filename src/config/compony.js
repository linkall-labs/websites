const componyConfig = {
    ...
    componyIndroduceList:[{
        ...
        title:'Vision',
        subtitle:'Become the most popular platform worldwide in Event-Driven architecture development',
        content:''
    },{
        title:'Value',
    ...
    contactIntroduce:'Thanks for your interest in Linkall. Please take a minute to fill out the form below and we will get back to you shortly.',
    contactForm:[{
        key:'firstname',
