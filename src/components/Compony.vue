    ...
    <div class="compony-introduce-container">
      ...
      >
        ...
        <div class="introduce-page">
          ...
          <div class="introduce-subtitle">{{ item.subtitle }}</div>
...
.compony-page-container {
  ...
  .contact-us-container {
    ...
    .contact-us-page {
      ...
      background: #fff;
      z-index: 1;
      box-shadow: 0px 2px 4px 4px rgba(189, 189, 189, 0.5);
